        ...
        DispatchQueue.main.async {
            ...
            if success {
                ...
                let alert = UIAlertController(
                    title: .tr("Fyreplace.LoginViewController.loginError.title"),
                    message: .tr("Fyreplace.LoginViewController.loginError.message"),
                    preferredStyle: .alert
                )
                let ok = UIAlertAction(
                    title: .tr("Fyreplace.LoginViewController.loginError.ok"),
                    style: .default
                )
                alert.addAction(ok)
